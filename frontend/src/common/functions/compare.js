...
function timeOverlap(user_start, user_end, app) {
    let user_start_in_min = 60 * Number(user_start.substring(0, 2)) + Number(user_start.substring(3));
    let user_end_in_min = 60 * Number(user_end.substring(0, 2)) + Number(user_end.substring(3));

    let app_start_in_min = 60 * Number(app.start.substring(0, 2)) + Number(app.start.substring(3));
    let app_end_in_min = 60 * Number(app.end.substring(0, 2)) + Number(app.end.substring(3));
